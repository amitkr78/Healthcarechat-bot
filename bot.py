    ...
    def tree_to_code(tree, feature_names):
        ...
        def recurse(node, depth):
            ...
            if tree_.feature[node] != _tree.TREE_UNDEFINED:
                ...
                res1=print("symptoms present  " + str(list(symptoms_present)))
                print(*res1,sep=",")
                res2=print("symptoms given "  +  str(list(symptoms_given)) )  
                print(*res2,sep=",")
                ...
                res3=print('Consult ', str(row['name'].values))
                print(*res3,sep=[','])
                res4=print('Visit ', str(row['link'].values))
                print(*res4,sep=[','])
